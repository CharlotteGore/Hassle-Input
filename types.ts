...
export type DeviceBindings<D extends ActionKey, A extends ActionKey, T extends ActionKey> = GamepadBindings<D, A, T> | MouseBindings<D, A, T> | KeyboardBindings<D, A, T>;
