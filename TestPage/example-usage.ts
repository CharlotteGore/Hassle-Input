import { InputBindings, GamepadButtons, MouseButtons, MouseAxis, Keys, GamepadAxis } from '../types';
...
const bindings: InputBindings<ButtonActions, AxisActions, TouchActions> = {
    gamepad: {
        buttons: {
            ...
            [GamepadButtons.DPadUp]: ButtonActions.MoveUp,
            [GamepadButtons.DPadDown]: ButtonActions.MoveDown,
            [GamepadButtons.DPadLeft]: ButtonActions.MoveLeft,
            [GamepadButtons.DPadRight]: ButtonActions.MoveRight,
    ...
    touch: {
        enabled: ButtonActions.TouchActive,
...
inputManager.setMouseAndTouchActiveElement(container);

const update = () => {
    inputManager.update();
    container.innerHTML = JSON.stringify(inputManager.getActionStatus(), null, 2);
